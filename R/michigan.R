...
hm %>%
  ...
  plot_3d(heightmap = hm, solid = FALSE, 
          ...
          phi = 90, zoom = .5, theta = 0, background = "white")


render_camera(phi = 90, theta = 0, zoom = .8, fov = 0)


render_highquality("michigan_hq_env_batlow.png", parallel = TRUE, 
...
img <- image_read("michigan_hq_env_paquin.png")
...
img_ <- image_annotate(img_, "Lake michigan", 
                       font = "Cinzel Decorative", location = "+650+100",
                       color = text_color, size = 150, gravity = "east")
...
magick::image_write(img_, "michigan_hq_env_panquin_titled.png")
...
img <- image_read("michigan_hq_env_batlow.png")
...
magick::image_write(img_, "michigan_hq_env_batlow_titled.png")
