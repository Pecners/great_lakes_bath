...
render_highquality("superior_hq_env_deeper_batlow.png", parallel = TRUE, 
...
img <- image_read("superior_hq_env_deeper_paquin.png")
...
img_ <- image_annotate(img, "Great Lake Depths", font = "Cinzel Decorative",
                       ...
                       location = "+150+200")
# Subtitle
img_ <- image_annotate(img_, "Lake Superior", 
                       font = "Cinzel Decorative", location = "+750+500",
...
magick::image_write(img_, "superior_hq_env_panquin_titled.png")
...
img <- image_read("superior_hq_env_deeper_batlow.png")
...
magick::image_write(img_, "superior_hq_env_batlow_titled.png")
